...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Gheez", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Gheez</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The Gheez developers", Q_NULLPTR));
