...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 G"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 G"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 G"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 G"));
        ...
        labelBalance->setText(QStringLiteral("123.456 G"));
