...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { while (true) {
        ...
        LogPrintf("Running GheezMiner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("GheezMiner terminated\n");
        throw;
    }
}
