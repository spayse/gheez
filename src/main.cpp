...
#if defined(NDEBUG)
# error "Gheez cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Gheez Signed Message:\n";
...
static const int64_t nTargetTimespan = 10 * 60; // 1 hour
